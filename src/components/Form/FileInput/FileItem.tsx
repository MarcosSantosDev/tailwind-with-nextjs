    ...
    <div className={container()}>
      ...
      {state === 'error' ? (
        <div className="flex flex-1 flex-col items-start gap-1">
          ...
          <button
            type="button"
            className="text-error-700 hover:text-error-900 dark:text-error-300 dark:hover:text-error-200 text-sm font-semibold"
          >
            Try again
          </button>
        </div>
      ...
      {state === 'complete' ? (
        ...
        <Button type="button" variant="gost" className={deleteButton()}>
